...
#'
#' @export
sncp_mcmc_cont2 <- function(obs_points, centers, mean_mu_alpha, sd_log_alpha, sd_prop_alpha, beta, n_it, window_hw, df_iw_prior, df_iw_prop, sigma_prior, xwin, ywin, var_mu_alpha, pen_dist, pen_val, prior_n_cent, max_bd_events, max_bd_vt) {
    .Call(`_sncp_sncp_mcmc_cont2`, obs_points, centers, mean_mu_alpha, sd_log_alpha, sd_prop_alpha, beta, n_it, window_hw, df_iw_prior, df_iw_prop, sigma_prior, xwin, ywin, var_mu_alpha, pen_dist, pen_val, prior_n_cent, max_bd_events, max_bd_vt)
}
